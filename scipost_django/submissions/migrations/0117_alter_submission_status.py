...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('submissions', '0116_submissiongroupobjectpermission_submissionuserobjectpermission'),
    ]
