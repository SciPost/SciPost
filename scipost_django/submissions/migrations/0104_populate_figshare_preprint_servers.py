...
def populate_figshare_preprint_servers(apps, schema_editor):
    ...
    chemrxiv, created = PreprintServer.objects.get_or_create(
        ...
        served_by=figshare)
    if created:
        chemrxiv.acad_fields.add(
            AcademicField.objects.get(name='Chemistry'))
        chemrxiv.save()
    ...
    techrxiv, created = PreprintServer.objects.get_or_create(
        ...
        served_by=figshare)
    if created:
        techrxiv.acad_fields.add(
            AcademicField.objects.get(name='Computer Science'))
        techrxiv.save()

    advance, created = PreprintServer.objects.get_or_create(
        name='Advance',
        url='https://advance.sagepub.com/',
        served_by=figshare)
    if created:
        advance.acad_fields.add(
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(populate_figshare_preprint_servers,
