...
from common.views.htmx import HXDynselAutocomplete, HXFormSetView
...
class HXTopicInterestFormSetView(PermissionsMixin, HXFormSetView):
    ...
    def get_permission_required(self) -> list[str]:
        ...
        # Only allow users to edit their own topic interests
        if self.request.user.contributor.profile.id != self.kwargs.get("profile_id"):
            permissions.append("scipost.can_view_profiles")
