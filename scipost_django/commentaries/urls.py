...
urlpatterns = [
    # Commentaries
    path("", views.CommentaryListView.as_view(), name="commentaries"),
    path(
        "howto",
    ...
    path("request_commentary", views.request_commentary, name="request_commentary"),
    path(
    ...
    path("prefill_using_DOI", views.prefill_using_DOI, name="prefill_using_DOI"),
    path(
