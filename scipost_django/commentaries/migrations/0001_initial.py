        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "arxiv_link",
                    models.URLField(
                        blank=True, verbose_name="arXiv link (including version nr)"
                    ),
                ),
                (
                    "pub_DOI",
                    models.CharField(
                        blank=True,
                        max_length=200,
                        verbose_name="DOI of the original publication",
                    ),
                ),
                (
                    "pub_DOI_link",
                    models.URLField(
                        blank=True, verbose_name="DOI link to the original publication"
                    ),
                ),
                (
                    "metadata",
