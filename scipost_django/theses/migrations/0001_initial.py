    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_as_cont', models.ManyToManyField(blank=True, related_name='theses', to='scipost.Contributor')),
                ('author_claims', models.ManyToManyField(blank=True, related_name='claimed_theses', to='scipost.Contributor')),
                ('author_false_claims', models.ManyToManyField(blank=True, related_name='false_claimed_theses', to='scipost.Contributor')),
                ('requested_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='requested_theses', to='scipost.Contributor')),
                ('supervisor_as_cont', models.ManyToManyField(blank=True, related_name='supervised_theses', to='scipost.Contributor', verbose_name='supervisor(s)')),
