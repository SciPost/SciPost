...
def from_astrophysics_to_astronomy(apps, schema_editor):
    ...
    Journal.objects.filter(discipline="astrophysics").update(discipline="astronomy")
    Publication.objects.filter(discipline="astrophysics").update(discipline="astronomy")
