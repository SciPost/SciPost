    ...
    def send_registration_invitation_email(cls, renew=False):
        ...
        if cls.invitation.invitation_type == 'R':
            ...
            email_text += (
                ...
                'we would appreciate a timely response from you, ideally within the next 2 days.\n\n'
            ...
            email_text_html += (
                ...
                'we would appreciate a timely response from you, ideally within the next 2 days.</p>'
