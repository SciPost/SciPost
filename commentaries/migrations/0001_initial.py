    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('published', 'published paper'), ('preprint', 'arXiv preprint')], max_length=9)),
                ...
                ('arxiv_identifier', models.CharField(blank=True, max_length=100, verbose_name='arXiv identifier (including version nr)')),
                ('arxiv_link', models.URLField(blank=True, verbose_name='arXiv link (including version nr)')),
                ('pub_DOI', models.CharField(blank=True, max_length=200, verbose_name='DOI of the original publication')),
                ...
                ('arxiv_or_DOI_string', models.CharField(max_length=100, verbose_name='string form of arxiv nr or DOI for commentary url')),
                ...
                ('pub_date', models.DateField(blank=True, null=True, verbose_name='date of original publication')),
