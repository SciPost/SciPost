...
urlpatterns = [
    ...
    url(r'^mark_report_doi_not_needed/(?P<report_id>[0-9]+)$',
        journals_views.mark_report_doi_not_needed,
        name='mark_report_doi_not_needed'),
    url(r'^mark_comment_doi_not_needed/(?P<comment_id>[0-9]+)$',
        journals_views.mark_comment_doi_not_needed,
        name='mark_comment_doi_not_needed'),
